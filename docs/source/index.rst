pycliques2 documentation
========================

This is the documentation of **pycliques2**. This is an extension to the library `networkx <https://networkx.github.io/>`_ in order to work with the clique graph operator.
